...
<body>
            ...
            <div class="col-md-8 offset-md-2 d-flex align-items-center justify-content-center">
                <div>
                    <div>
                        ...
                        <h3 class="text-left font-weight-bold" style="padding-left: 50px; padding-top: 45px; margin-bottom: 20px; font-weight: bold;">Add a Supplier</h3>
                        <h5 class="text-left font-weight-semi-bold" style="padding-left: 50px; margin-bottom: 20px; font-weight: bold;">Create a new Supplier's Database.</h5>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 d-flex justify-content-end">
                                            <div class="form-group" style="padding-top: 35px;">
                                                <button type="button" class="mr-2 btn btn-primary" style="background-color: black; margin-right: 10px;" onclick="confirmAddSupplier()">Add Supplier</button>
    ...
    <div id="confirmPopup" class="popup-container">
        <div class="popup-content">
            <p>Are you sure you want to add the supplier and their information?</p>
            <button class="btn-confirm" onclick="addSupplier()">Yes</button>
            <button class="btn-cancel" onclick="hidePopup('confirmPopup')">No</button>
        </div>
    </div>

    <div id="successPopup" class="popup-container">
        <div class="popup-content">
            <p>Supplier added. The supplier and their information has been successfully added.</p>
            <button class="btn-confirm" onclick="hidePopup('successPopup')">Close</button>
        </div>
    </div>
</body>
